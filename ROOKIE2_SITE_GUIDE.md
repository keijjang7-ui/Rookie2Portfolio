...
- Visual Principles에서 현재 쓰는 자산은 `card-principles-graphic.svg`, `card-vision-grid.png`, `card-understood-visual.webp`, `card-expressive-gaze-bg.webp`, `card-future-form.webp`입니다. 예전 백업이나 이전 카드 이미지는 보관하지 않습니다.
